...
class tournamentModel extends Model
{
    ...
    /**
     * @param string $type kpl,lol
     * @param int $limt
     * @return mixed
     */
    public function getTournamentResult($game = '')
    {
        $tournamentObj = $this->select('tournament_id', 'game', 'tournament_name');
        if ($game != '') {
            $tournamentObj->where('game', $game);
        }

        return $tournamentObj->orderBy('start_time', 'desc')
            ->get()
            ->toArray();
    }
}
