...
namespace App\Models\Match\ray;
...
{
    protected $table = "ray_match_list";
    ...
    public function getMatchList($params)
    {
        ...
        $fields = $params['fields'] ?? "match_id,game,match_status,tournament_id,home_id,away_id,home_name,away_name,home_logo,away_logo,home_odds,away_odds,start_time";
